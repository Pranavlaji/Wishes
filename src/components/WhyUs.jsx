        ...
        <section id="why-us" className="why-us-section">
            ...
            <div className="why-us-grid">
                ...
                <div className="grid-card card-collaborative">
                    ...
                    <img src="public/bentoCollab.webp" alt="Collaborative Process" className="card-bg-img" />
                </div>

                {/* 2. 24/7 Support (Span 2 col, 1 row) */}
                <div className="grid-card card-support">
                    <span className="card-title">24/7 Support</span>
                    <img src="public/bento6.png" alt="Collaborative Process" className="card-bg-img" />
                </div>
                ...
                <div className="grid-card card-cinematic">
                    ...
                    <img src="public/image.png" alt="Cinematic Production" className="card-bg-img" />
                </div>
                ...
                <div className="grid-card card-speed">
                    ...
                    <img src="public/bentofast.webp" alt="Speed" className="card-bg-img" />
                </div>
                ...
                <div className="grid-card card-identity">
                    ...
                    <img src="public/bento5.webp" alt="camera" className="card-bg-img" />
                </div>
                ...
                <div className="grid-card card-engagement">
                    ...
                    <img src="public/bento8.png" alt="speaker" className="card-bg-img" />
                </div>
                ...
                <div className="grid-card card-perfection">
                    ...
                    <img src="public/bento2.png" alt="speaker" className="card-bg-img" />
                </div>

                {/* 8. Flexible Pricing (Span 2 col) */}
                <div className="grid-card card-pricing">
                    <span className="card-title">Flexible Pricing</span>
                    <img src="public/bento9.png" alt="speaker" className="card-bg-img" />
                </div>
                ...
                <div className="grid-card card-clarity">
                    ...
                    <img src="public/bento10.png" alt="speaker" className="card-bg-img" />
                </div>
            </div>
        </section>
    );
